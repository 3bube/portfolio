    ...
    >
      ...
      >
        <div className="col-span-4">
          ...
          >
            I am currently open to any project or job opportunities. Feel free
            to reach out to me via email at{" "}
            <a href="mailto:ugbore2@gmail.com" className="text-accent-400">
              ugbore2@gmail.com
            </a>
            .
          </p>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://www.linkedin.com/in/ebubechukwu-ugbor-800744244/"
